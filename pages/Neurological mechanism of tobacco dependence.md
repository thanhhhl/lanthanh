...
- **Imaging Tobacco Smoking with PET and SPECT**
	...
	- **Imaging beta 2*-Nicotinic Acetylcholine Receptors - Imaging the Normalization of beta 2*-nAChRs in Tobacco Smokers**
		...
		- The type of cigarette smoked modulates the degree of upregulation. Cigarettes containing menthol, which are used by up to 1/3 of smokers, lead to higher β2*-nAChR availability (as it inhibits nicotine metabolism) than non-menthol-containing cig- arettes (Brody et al. 2013a).
...
- **Behavioral Mechanisms Underlying Nicotine Reinforcement**
	...
	- **Primary Reinforcing Actions of Nicotine**
	...
	- **_Conditioned Responses to Nicotine-Associated Stimuli_**
	- 32
